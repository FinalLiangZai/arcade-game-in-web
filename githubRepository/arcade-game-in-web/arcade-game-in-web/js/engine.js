...
var Engine = (function(global) {
    ...
    canvas.width = dimens.canvasWidth;
    canvas.height = dimens.canvasHeight;
    ...
    function render() {
        ...
        var rowImages = [
            ...
            numRows = dimens.numRows,
            numCols = dimens.numCols,
            row, col;
        ...
        for (row = 0; row < numRows; row++) {
            for (col = 0; col < numCols; col++) {
                 ...
                 */
                ctx.drawImage(Resources.get(rowImages[row]), col * (dimens.perColWidth), row * (dimens.perRowHeight));
            }
        }
